...
@WebServiceClient(name = "WebServiceSessionBeanService", 
                  wsdlLocation = "http://localhost:8080/examen-java-webservice/WebServiceSessionBean?wsdl",
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WebServiceSessionBeanService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/examen-java-webservice/WebServiceSessionBean?wsdl");
        }
        WSDL_LOCATION = url;
    }
