        ...
        <div class="col mb-2">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 text-right">
                    <a href="CommandeServlet?action=ajouterCommande&idPanier=<%= panier.getId()%>"><button class="btn btn-lg btn-block btn-success text-uppercase"><fmt:message key="panier.checkout" /></button></a>
                </div>
            </div>
        </div>
    </div>
